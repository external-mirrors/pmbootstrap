...
def get(args, pkgname, arch, replace_subpkgnames=False, must_exist=True):
    ...
    if (
        arch in pmb.helpers.other.cache[cache_key]
        and pkgname in pmb.helpers.other.cache[cache_key][arch]
        and replace_subpkgnames in pmb.helpers.other.cache[cache_key][arch][pkgname]
    ):
        return pmb.helpers.other.cache[cache_key][arch][pkgname][replace_subpkgnames]
    ...
    if ret:
        ...
        pmb.helpers.other.cache[cache_key][arch][pkgname][replace_subpkgnames] = ret
        return ret
