...
class ApkindexBlock:
    ...
    def __init__(
        ...
        self._block["arch"] = arch
        self._block["depends"] = depends
        self._block["origin"] = origin
        self._block["pkgname"] = pkgname
        self._block["provides"] = provides
        self._block["provider_priority"] = provider_priority
        self._block["timestamp"] = timestamp
        self._block["version"] = version
