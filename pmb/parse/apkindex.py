...
def providers(package, arch: Arch | None = None, must_exist=True, indexes=None, user_repository=True):
    """
...
def package(package, arch: Arch | None = None, must_exist=True, indexes=None, user_repository=True):
    ...
    package_providers = providers(package, arch, must_exist, indexes, user_repository=user_repository)
